<template>
  <div class="projects-container">
    <div class="page-header">
      <h2>项目列表</h2>
      <el-button type="primary" @click="router.push({ path: '/project-add', query: { fresh: 1 } })">
    ...
    <el-card class="projects-card">
      ...
      <el-table :data="filteredProjects" style="width: 100%" v-loading="loading" row-key="id">
